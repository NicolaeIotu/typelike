 ...
 */module.exports.typelike=function(obj,templates){const lastIndex=arguments.length-1;if(lastIndex<1)throw new Error("At least two parameters required.");let result=!1;for(let i=1;i<=lastIndex;i++)result=result||compare(obj,arguments[i]);return resetOptions(),result}
/**
 ...
 */,module.exports.typelikeCustom=function(obj,templates,settings){const lastIndex=arguments.length-1;if(lastIndex<2)throw new Error("At least three parameters required.");return typelikeSettings=arguments[lastIndex],module.exports.typelike.apply(null,Array.from(arguments).filter((function(e,i){return i!==lastIndex})))};